...
export function Hero() {
  ...
  return (
    <header className="pt-20 pb-6 px-6 text-center max-w-4xl mx-auto relative">
      ...
      >
        Learn to consolidate fragmented industries and build enterprise value — the exact playbook used by the world's most successful private equity firms.
      </motion.p>
      ...
      >
        <div className="flex-1 p-5 md:p-6 text-center border-b md:border-b-0 md:border-r border-ink-100">
          <div className="font-serif text-3xl md:text-4xl font-bold text-ink-900">
            <em className="italic text-aryo">8-12</em> mo
          </div>
          <div className="text-[9px] font-bold tracking-[0.1em] uppercase text-ink-300 mt-1">Program Duration</div>
        </div>
        <div className="flex-1 p-5 md:p-6 text-center border-b md:border-b-0 md:border-r border-ink-100">
          <div className="font-serif text-3xl md:text-4xl font-bold text-ink-900">
            <em className="italic text-aryo">$10M+</em>
          </div>
          <div className="text-[9px] font-bold tracking-[0.1em] uppercase text-ink-300 mt-1">Avg Deal Size</div>
        </div>
        <div className="flex-1 p-5 md:p-6 text-center">
          <div className="font-serif text-3xl md:text-4xl font-bold text-ink-900">
            <em className="italic text-aryo">Proven</em>
          </div>
          <div className="text-[9px] font-bold tracking-[0.1em] uppercase text-ink-300 mt-1">Framework</div>
        </div>
      </motion.div>
